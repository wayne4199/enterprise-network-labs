...
PHASE 01 Ver.2 extends the original foundation scope by adding routed links, static routing, Internet Simulation reachability, and persistent configuration for long-term server nodes.
